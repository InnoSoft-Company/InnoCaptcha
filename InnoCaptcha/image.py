...
class ImageCaptcha:
    ...
    def save(self, path=None):
        ...
        # Allow absolute paths but prevent trivial traversal if desired. 
        # For a library, trusting the developer is usually standard unless it's a security-focused sandbox.
